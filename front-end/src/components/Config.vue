          ...
          <v-row align="center" justify="center">
            <v-col cols="12" sm="8" md="4">
              <v-card class="elevation-12">
                ...
                <v-card-text>
                  <v-form>
                    <v-text-field v-model="gk" label="Number of goalkeepers" name="gk" type="text" />
                    ...
                    <v-text-field v-model="df" label="Number of defenders" name="df" type="text" />
                    <v-text-field v-model="fwd" label="Number of forwards" name="fwd" type="text" />
                    <v-text-field
                      v-model="mp"
